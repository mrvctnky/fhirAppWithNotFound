sap.ui.define([
	...
	"use strict";
		...
		return BaseController.extend("myhealthapp.controller.Patient", {
			onInit: function () {
				this._oTable = this.byId("patientsTable");
				this._oVSD = null;
				this._sSortField = null;
				this._bSortDescending = false;
				this._aValidSortFields = ["id", "name/[use='official']/given", "name/[use='official']/family"];
			...
			onSearchPatientsTable : function (oEvent) {
			...
			_initViewSettingsDialog : function () {
				...
				this._oVSD.addSortItem(new sap.m.ViewSettingsItem({
					key: "name/[use='official']/given",
					text: "First Name",
					selected: false
				}));

				this._oVSD.addSortItem(new sap.m.ViewSettingsItem({
					key: "name/[use='official']/family",
					text: "Last Name",
					selected: false
				}));
			},
			...
			_applySearchFilter : function (sSearchQuery) {
				...
				if (sSearchQuery && sSearchQuery.length > 0) {
					aFilters.push(new Filter("name/[use='official']/given", FilterOperator.Contains, sSearchQuery));
					aFilters.push(new Filter("name/[use='official']/family", FilterOperator.Contains, sSearchQuery));
